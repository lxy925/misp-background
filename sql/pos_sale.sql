...
CREATE TABLE `pos_sale`  (
    `sale_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '销售ID',
    `sale_no` varchar(32) NULL DEFAULT NULL COMMENT '销售单号',
    ...
    `status` varchar(10) NULL DEFAULT NULL COMMENT '订单状态',
